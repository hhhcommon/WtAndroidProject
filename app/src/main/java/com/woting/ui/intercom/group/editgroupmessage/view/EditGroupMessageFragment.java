package com.woting.ui.intercom.group.editgroupmessage.view;
...
import com.woting.common.view.pickview.LoopView;
import com.woting.common.view.pickview.OnItemSelectedListener;
import com.woting.ui.intercom.group.editgroupmessage.presenter.EditGroupMessagePresenter;
...
public class EditGroupMessageFragment extends Fragment implements View.OnClickListener {
    ...
    public void setViewForGroupIntroduce(String s) {
        if (s != null && !s.trim().equals("")) {
            ...
            tv_groupIntroduce.setTextColor(Color.parseColor("#16181a"));
        } else {
            tv_groupIntroduce.setText("");
            tv_groupIntroduce.setTextColor(Color.parseColor("#cccccd"));
        }
    }
            ...
            dialog.findViewById(R.id.tv_confirm).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        String p = provinceList.get(provinceIndex);
                        if (p != null && !p.equals("")) {
