package com.woting.ui.mine.set.view;
...
import com.woting.ui.mine.about.AboutFragment;
import com.woting.ui.mine.feedback.view.FeedbackFragment;
import com.woting.ui.mine.messageset.MessageSettingFragment;
import com.woting.ui.mine.myfavorite.view.MyFavoriteFragment;
import com.woting.ui.mine.myfocus.view.MyFocusFragment;
import com.woting.ui.mine.personinfo.view.PersonalInfoFragment;
import com.woting.ui.mine.security.main.AccountSecurityFragment;
import com.woting.ui.mine.set.presenter.SettingPresenter;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.view_my_concern:// 我关注的
                LookListActivity.open(new MyFocusFragment());
                break;
            case R.id.view_my_sub:// 我订阅的
                /**
                 * 此处跳转传递参数，根据参数关闭的时候执行MineActivity.close();
                 */
                LookListActivity.open(MeSubscribeListFragment.newInstance());
                break;
            case R.id.view_like:// 我喜欢的
                LookListActivity.open(new MyFavoriteFragment());
                break;
            ...
            case R.id.view_message_settings:// 消息设置
                LookListActivity.open(new MessageSettingFragment());
                break;
            case R.id.view_clear_cache:// 清理缓存
                clearDialogShow();
                break;
            case R.id.view_account_security:// 账号安全
                LookListActivity.open(new AccountSecurityFragment());
                break;
            case R.id.view_feedback:// 意见反馈
                LookListActivity.open(new FeedbackFragment());
                break;
            case R.id.view_about:// 关于
                LookListActivity.open(new AboutFragment());
                break;
