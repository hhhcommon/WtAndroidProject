package com.woting.ui.mine.message.megcenter.view;
...
import com.woting.R;
import com.woting.ui.mine.message.megcenter.presenter.MsgCenterPresenter;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.head_left_btn:
                ...
                break;
            case R.id.re_notify:
                LookListActivity.open(new MsgNotifyFragment());
                break;
            case R.id.re_group:
                break;
        }
