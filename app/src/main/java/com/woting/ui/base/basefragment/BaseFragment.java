package com.woting.ui.base.basefragment;
...
import com.woting.ui.base.baseactivity.BaseToolBarActivity;
...
public abstract class BaseFragment extends Fragment implements View.OnClickListener {
    ...
    private LookListActivity playerActivityMain;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getActivity() instanceof PlayerActivity) {
            ...
            playerActivityMain = (LookListActivity) getActivity();
    ...
    public void openFragment(Fragment fragment) {
       /* if (!(this instanceof PlayerFragment))
        ...
        if (getActivity() instanceof PlayerActivity) {
            ...
            LookListActivity playerActivity = (LookListActivity) getActivity();
            playerActivity.open(fragment);
        } else if (getActivity() instanceof InterPhoneActivity) {
