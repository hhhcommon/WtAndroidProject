...
import com.woting.commonplat.nim.entertainment.constant.NetStateType;
import com.woting.commonplat.nim.entertainment.helper.NetDetectHelpter;
import com.woting.commonplat.nim.im.business.LogoutHelper;
...
public class IdentifyActivity extends TActivity implements View.OnClickListener {
    ...
    private void updateNetDetectLoading() {
        ...
        netDetectStateIv.setImageResource(R.mipmap.icon_net_detect_wifi_enable_0);
        ...
        if (netDetectResult.getCode() == 200) {
            ...
            switch (netGrade) {
                case SMOOTH:
                    ...
                    netDetectStateIv.setImageResource(R.mipmap.icon_net_detect_wifi_enable_4);
                    break;
                case COMMON:
                    netDetectStateContentTv.setText("网络状况：一般");
                    netDetectStateIv.setImageResource(R.mipmap.icon_net_detect_wifi_enable_3);
                    break;
                case POOR:
                    netDetectStateContentTv.setText("网络状况：较差");
                    netDetectStateIv.setImageResource(R.mipmap.icon_net_detect_wifi_enable_2);
                    break;
                case BAD:
                    netDetectStateContentTv.setText("网络状况：极差");
                    netDetectStateIv.setImageResource(R.mipmap.icon_net_detect_wifi_enable_1);
                    break;
            }
        } else {
            netDetectDetailInfoIv.setVisibility(View.GONE);
