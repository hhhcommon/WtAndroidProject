...
package com.woting.commonplat.nim.im.ui.tab;
...
import com.woting.commonplat.nim.im.ui.tab.reminder.ReminderItem;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorHeight = a
                .getDimensionPixelSize(R.styleable.PagerSlidingTab_pstsIndicatorHeight, indicatorHeight);
        underlineHeight = a
                .getDimensionPixelSize(R.styleable.PagerSlidingTab_pstsUnderlineHeight, underlineHeight);
