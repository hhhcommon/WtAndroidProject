package com.woting.commonplat.nim.im.ui.widget;
...
import com.woting.commonplat.nim.im.session.image.ImageLoaderKit;
import com.woting.commonplat.nim.im.util.media.ImageUtil;
...
public class AvatarImageView extends CircleImageView {
    ...
    private final DisplayImageOptions createImageOptions() {
        int defaultIcon = R.mipmap.avatar_def;
    ...
    public void loadAvatar(final String url, final int thumbSize) {
        // 先显示默认头像
        setImageResource(R.mipmap.avatar_def);
        ...
        if (needLoad) {
            ...
            // 异步从cache or NOS加载图片
//            ImageLoader.getInstance().displayImage(thumbUrl, new NonViewAware(new ImageUtil.ImageSize(thumbSize, thumbSize),
