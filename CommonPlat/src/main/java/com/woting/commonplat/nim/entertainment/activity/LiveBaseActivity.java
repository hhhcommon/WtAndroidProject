...
import com.woting.commonplat.nim.entertainment.constant.PushMicNotificationType;
import com.woting.commonplat.nim.entertainment.helper.ChatRoomMemberCache;
import com.woting.commonplat.nim.entertainment.helper.GiftAnimation;
import com.woting.commonplat.nim.entertainment.module.ChatRoomMsgListPanel;
import com.woting.commonplat.nim.entertainment.module.ConnectedAttachment;
import com.woting.commonplat.nim.entertainment.module.DisconnectAttachment;
import com.woting.commonplat.nim.entertainment.module.GiftAttachment;
import com.woting.commonplat.nim.entertainment.module.LikeAttachment;
import com.woting.commonplat.nim.im.session.Container;
import com.woting.commonplat.nim.im.session.ModuleProxy;
import com.woting.commonplat.nim.im.session.actions.BaseAction;
import com.woting.commonplat.nim.im.session.emoji.MoonUtil;
import com.woting.commonplat.nim.im.session.input.InputConfig;
import com.woting.commonplat.nim.im.session.input.InputPanel;
...
import com.woting.commonplat.nim.im.ui.periscope.PeriscopeLayout;
 ...
 */
public abstract class LiveBaseActivity extends TActivity implements ModuleProxy, AVChatStateObserver {
...
//    protected TextView interactionBtn; // 互动按钮
    ...
    protected View audioModeBgLayout; // 主播画面音频模式背景
    ...
    public void enterRoom() {
        ...
        enterRequest.setCallback(new RequestCallback<EnterChatRoomResultData>() {
            ...
            public void onException(Throwable exception) {
                onLoginDone();
                Toast.makeText(LiveBaseActivity.this, "enter chat room exception, e=" + exception.getMessage(), Toast.LENGTH_SHORT).show();
                if (isCreator) {
                    finish();
                }
            }
...
//            } else
            if (i == R.id.share_btn) {
                if (pullUrl != null) {
                    ...
                    // 将文本内容放到系统剪贴板里。
                    cm.setText(pullUrl);
                    EasyAlertDialogHelper.showOneButtonDiolag(LiveBaseActivity.this,
    ...
    private void EDialog() {
        EditDialog.showSecurityCodeInputDialog(this, new EditDialog.InputActivityProxy() {
            @Override
            public void onSendMessage(String text) {
                inputPanel.onTextMessageSendButtonPressed(text);
            }
