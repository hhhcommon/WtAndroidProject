package com.woting.commonplat.nim.im.util.media;
...
import com.woting.commonplat.nim.im.util.file.FileUtil;
...
public class ImageUtil {
	...
	public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(DemoCache.getContext().getResources(), R.mipmap.nim_image_download_failed);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
