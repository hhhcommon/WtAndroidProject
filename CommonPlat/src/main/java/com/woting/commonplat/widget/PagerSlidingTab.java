...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.wt_pager_silding_tab_background;
    ...
    public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        // 下面4个扩展的属性
        tabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTab_zmsTabTextSize, tabTextSize);
        tabTextColor = a.getColor(R.styleable.PagerSlidingTab_zmsTabTextColor, tabTextColor);

        // selectedTabTextSize=a.getDimensionPixelSize(R.styleable.PagerSlidingTab_zmsSelectedTabTextSize,
        // selectedTabTextSize);
        selectedTabTextColor = a.getColor(R.styleable.PagerSlidingTab_zmsSelectedTabTextColor, indicatorColor);
