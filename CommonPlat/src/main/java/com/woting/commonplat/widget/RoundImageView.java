...
public class RoundImageView extends ImageView {
    ...
    private static final int mBorderOutsideColor = 0;
    private static final int mBorderInsideColor = 0;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBorderInsideColor != defaultColor && mBorderOutsideColor != defaultColor) {// 定义画两个边框，分别为外圆边框和内圆边框
            ...
            drawCircleBorder(canvas, radius + mBorderThickness / 2, mBorderInsideColor);// 画内圆
            drawCircleBorder(canvas, radius + mBorderThickness + mBorderThickness / 2, mBorderOutsideColor);// 画外圆
    ...
    public Bitmap getCroppedRoundBitmap(Bitmap bmp, int radius) {
        ...
        if (bmpHeight > bmpWidth) {// 高大于宽
            ...
            squareBitmap = Bitmap.createBitmap(bmp, x, y, squareWidth, squareHeight);// 截取正方形图片
