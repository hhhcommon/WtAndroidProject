...
package com.woting.commonplat.receiver;
...
public class NetWorkChangeReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (action != null) {
			NetWorkManager.checkNetworkStatus(context); // 网络设置获取
	...
	public void doUnConnected() {
		Context.sendBroadcast(new Intent(BroadcastConstants.PUSH_NETWORK_UNCONNECTED));
	}
	...
	public void doConnected() {
		Context.sendBroadcast(new Intent(BroadcastConstants.PUSH_NETWORK_CONNECTED));
	}
