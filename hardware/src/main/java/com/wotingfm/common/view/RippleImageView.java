...
//    private ImageView img_bg;
    ...
    private void getAttributeSet(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ripple_imageView);
        show_spacing_time = typedArray.getInt(R.styleable.ripple_imageView_show_spacing_time, SHOW_SPACING_TIME);
        imageViewWidth = typedArray.getDimension(R.styleable.ripple_imageView_imageViewWidth, IMAMGEVIEW_SIZE);
        imageViewHeigth = typedArray.getDimension(R.styleable.ripple_imageView_imageViewHeight, IMAMGEVIEW_SIZE);
...
//        img_bg.setImageResource(R.mipmap.point_empty);
