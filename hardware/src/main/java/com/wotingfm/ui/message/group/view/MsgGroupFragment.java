package com.wotingfm.ui.message.group.view;
...
import com.wotingfm.ui.message.group.adapter.GroupMsgAdapter;
import com.wotingfm.ui.message.group.model.GroupMsg;
import com.wotingfm.ui.message.group.presenter.MsgGroupPresenter;
 ...
 * 邮箱：645700751@qq.com
 */
public class MsgGroupFragment extends Fragment implements GroupMsgAdapter.IonSlidingViewClickListener, View.OnClickListener, TipView.TipViewClick {
    private View rootView;
    private MsgGroupPresenter presenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (rootView == null) {
            ...
            inItView();
            presenter = new MsgGroupPresenter(this);
        }
        return rootView;
    }
    ...
    // 适配数据
    public void updateUI(List<GroupMsg> list) {
        if (mAdapter == null) {
            mAdapter = new GroupMsgAdapter(this.getActivity(), list);
