package com.wotingfm.ui.message.person.view;
...
import com.wotingfm.ui.message.person.presenter.MsgPersonPresenter;
 ...
 * 邮箱：645700751@qq.com
 */
public class MsgPersonFragment extends Fragment  implements FriendMsgAdapter.IonSlidingViewClickListener, View.OnClickListener, TipView.TipViewClick {
    private View rootView;
    private MsgPersonPresenter presenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (rootView == null) {
            ...
            inItView();
            presenter = new MsgPersonPresenter(this);
        }
        return rootView;
    }
    ...
    // 适配数据
    public void updateUI(List<FriendMsg> list) {
        if (mAdapter == null) {
            mAdapter = new FriendMsgAdapter(this.getActivity(), list);
