package com.wotingfm.ui.message.person.adapter;
...
public class FriendMsgAdapter extends RecyclerView.Adapter<FriendMsgAdapter.SimpleHolder> implements SlidingButtonView.IonSlidingButtonListener {
    private List<FriendMsg> mData;
    private Context mContext;

    private IonSlidingViewClickListener mIDeleteBtnClickListener;
    private SlidingButtonView mMenu;

    public FriendMsgAdapter(Context context, List<FriendMsg> friendList) {
        this.mContext = context;
        this.mData = friendList;
    }

    public void changeData(List<FriendMsg> friendList) {
        this.mData = friendList;
    ...
    public void onBindViewHolder(final SimpleHolder holder, int position) {
        FriendMsg m = mData.get(position);
    ...
    class SimpleHolder extends RecyclerView.ViewHolder {
        ...
        public SimpleHolder(View itemView) {
            ...
            ((SlidingButtonView) itemView).setSlidingButtonListener(FriendMsgAdapter.this);
        }
    }
