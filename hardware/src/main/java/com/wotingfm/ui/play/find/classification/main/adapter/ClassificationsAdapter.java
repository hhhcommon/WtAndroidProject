...
// * 邮箱：645700751@qq.com
// */
//public class ClassificationsAdapter extends CommonAdapter<Classification.DataBeanX> {
//    private Context context;
//    private TagClickBase tagClickBase;
//    private GridSpacingItemDecoration gridSpacingItemDecoration;
//
//    public ClassificationsAdapter(Context context, List<Classification.DataBeanX> datas, TagClickBase tagClickBase) {
//        super(context, R.layout.item_class_home, datas);
//        this.context = context;
//        this.tagClickBase = tagClickBase;
//        gridSpacingItemDecoration = new GridSpacingItemDecoration(4, context.getResources().getDimensionPixelSize(R.dimen.padding_middle_16), true);
//    }
//
//    @Override
...
//            if (dataBean.logo != null && !dataBean.logo.equals("")) {
//                GlideUtils.loadImageViewRound(dataBean.logo, ivClass);
//            } else {
