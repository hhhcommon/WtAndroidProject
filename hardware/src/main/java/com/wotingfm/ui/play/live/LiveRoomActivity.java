...
import com.woting.commonplat.nim.entertainment.activity.*;
...
import com.woting.commonplat.nim.entertainment.constant.MicApplyEnum;
...
import com.woting.commonplat.nim.entertainment.helper.SimpleCallback;
 ...
 */
public class LiveRoomActivity extends LivePlayerBaseActivity implements VideoPlayer.VideoPlayerProxy {
...
//                    Toast.makeText(AudienceActivity.this, "观众进入房间失败, code=" + code + ", errorMsg:" + errorMsg, Toast.LENGTH_SHORT).show();
    ...
    private void initAudienceParam() {
        ...
        videoPlayer = new VideoPlayer(this, videoView, null, pullUrl,
    ...
    private void doVideoLink() {
        ...
        ChatRoomHttpClient.getInstance().pushMicLink(roomId, DemoCache.getAccount(), ext, new ChatRoomHttpClient.ChatRoomHttpCallback<Void>() {
            ...
            public void onFailed(int code, String errorMsg) {
                ...
                if (code == 419) {
//                    Toast.makeText(this, "队列已满", Toast.LENGTH_SHORT).show();
                } else {
//                    Toast.makeText(this, "join queue failed, code:" + code + ", errorMsg:" + errorMsg, Toast.LENGTH_SHORT).show();
                }
                revertPushUI();
            }
        });
...
//                Toast.makeText(this, "http push mic link errorMsg:" + errorMsg, Toast.LENGTH_SHORT).show();
                revertPushUI();
            }
        });
    }
