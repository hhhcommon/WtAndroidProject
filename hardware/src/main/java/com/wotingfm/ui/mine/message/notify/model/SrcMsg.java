...
public class SrcMsg implements Serializable {
    ...
    public void setGroup_apply_mes(List<applyMes> group_apply_mes) {
        this.group_apply_mes = group_apply_mes;
    }

    public List<approveMes> getGroup_approve_mes() {
        return group_approve_mes;
    }

    public void setGroup_approve_mes(List<approveMes> group_approve_mes) {
        this.group_approve_mes = group_approve_mes;
    }

    public List<MesPerson> getFriend_apply_mes() {
        return friend_apply_mes;
    }

    public void setFriend_apply_mes(List<MesPerson> friend_apply_mes) {
        this.friend_apply_mes = friend_apply_mes;
    }

    public static class applyMes implements Serializable {
    ...
    public static class approveMes implements Serializable {
