...
public class MainPresenter extends BasePresenter {
    ...
    public void connectToRoom(String roomId, boolean commandLineRun, boolean loopback,
        ...
        // Get setting keys.
        PreferenceManager.setDefaultValues(BSApplication.getInstance(), R.xml.preferences, false);
        sharedPref = PreferenceManager.getDefaultSharedPreferences(BSApplication.getInstance());
